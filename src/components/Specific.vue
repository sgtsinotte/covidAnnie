<template>
  <div class="specific">
    ...
    <div class="charts">
      <Chart msg="Glucose"  :min=3.9 :max=8.1 :svg_width=300 :svg_height=250 :margin=60 className="glucose" :values="getRawValue(customer.glucose)"/>
      <Chart msg="Insulin"  :min=3.9 :max=8.1 :svg_width=300 :svg_height=250 :margin=60 className="insulin" :values="getRawValue(customer.insulin)"/>
      <Chart msg="Heart rate" :min=59 :max=100 :svg_width=300 :svg_height=250 :margin=60 className="heartRate" :values="getRawValue(customer.heartRate)"/>
